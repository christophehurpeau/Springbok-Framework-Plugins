<?php new View(_t('plugin.contactForm.Contact')); HMeta::canonical('/site/contact') ?>
...
<?php $form=HForm::create(NULL,array('action'=>'/site/contact_submit')) ?>
...
<? $form->input('subject',array('label'=>_t('plugin.contactForm.Subject:'),'size'=>70)) ?>
